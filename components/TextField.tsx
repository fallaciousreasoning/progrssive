...
export default function TextField(props: TextFieldProps) {
    ...
    return <div className={`${className} w-full bg-input opacity-90 hover:opacity-100 rounded-t-md border-b transition-colors ${hasFocus ? 'border-primary' : 'border-black'}`}>
